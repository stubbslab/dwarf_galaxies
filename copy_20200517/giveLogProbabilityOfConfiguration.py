...
def giveLogProbabilityOfConfiguration(population, withDisk = 0, disk_funct = 0, halo_funct = 0, pop_selection_method='none',
    ...
    print 'The total log likelihood of the configuration is ' + str(current_brightness_profile.sumSurfaceBrightness(star_data.corrRa,star_data.corrDec))
