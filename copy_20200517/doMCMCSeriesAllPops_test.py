...
if __name__ == '__main__':
    #parameters at present are: [halo_type, disk_type, galaxy, number of iterations, population selection method, withDisk, start parameter index, outer step, halo edge on, disk edge on, fixed disk angle, fixed halo angle, prolate_or_oblate, specified_param_ranges] 
    parameter_series = [ ['nfw', 'sech_disk', 'fornax', 20, 'metal_rigid', 0, 0, 2.0, 1, 1, None, None, 'oblate', {'el':[0.1, 1.0]}],
                         ['cored', 'sech_disk', 'fornax', 20, 'metal_rigid', 0, 1, 2.0, 1, 1, None, None, 'oblate', {'el':[0.1, 1.0]}],
                         ['burkert', 'sech_disk', 'fornax', 20, 'metal_rigid', 0, 2, 2.0, 1, 1, None, None, 'oblate', {'el':[0.1, 1.0]}],
