...
if __name__ == '__main__':
    ...
    parameter_series = [ #['nfw','sech_disk','fornax',4000,'metal_point',1,0,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,1,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,2,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,3,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,4,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,5,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,6,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,7,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,8,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,9,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,10,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,11,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,12,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,13,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,14,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,15,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,16,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,17,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,18,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,19,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,20,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,21,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,22,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,23,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,24,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,25,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,26,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,27,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,28,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,29,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,30,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,31,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,32,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,33,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,34,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,35,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,36,2.0],
                         #['nfw','sech_disk','fornax',4000,'metal_point',1,37,2.0],
                         ['burkert','sech_disk','fornax',40,'metal_point',1,38,2.0],
                         ['cored','sech_disk','fornax',40,'metal_point',1,39,2.0],
                         ['nfw','sech_disk','fornax',40,'metal_point',1,40,2.0],
                         ['nfw','sech_disk','fornax',40,'metal_point',1,41,2.0]
                       ]
    saverun = 1
    show_best_fit = 0
    artificial = 0
        ...
        for j in range(len(artificial_param_indeces)): 
            ...
            if artificial: 
                ...
                runMCMCForDwarfGalaxyProfilesAllPops(
                    ...
                    withDisk=parameter_series[i][withDisk_index], nIterations = parameter_series[i][nIter_index], saverun = saverun, show_best_fit = show_best_fit,
                    pop_selection_method = parameter_series[i][pop_select_index], start_param_index = parameter_series[i][start_index_index], outer_step = parameter_series[i][step_index],
                    use_artificial_data = artificial, generation_params_storer_index = 'None', generation_disk_funct = 0, generation_halo_funct = 0, apply_crowding_mask = 1)
