...
if __name__ == '__main__':
    ...
    start_param_index = 10
    mask_R_bins = 100 # 200
    mask_z_bins = 100 # 200
    max_sky_angle_deg = None
    n_iters_to_save = 100
    target_n_sky_pixels = 500 #1000
    n_los_bins = 21 #41
    ...
    pop_independent_params = ['M', 'rs', 'el', 'halo_center', 'halo_sym_axis', 'eps', 'Rd', 'lam', 'disk_center', 'disk_sym_axis']
    extra_save_str = '_test_prob_match' + '_includeMorph' + str(include_morph_prob) + '_includeKinemProb' + str(include_kinem_prob)
    #extra_save_str = ''
