...
class SharedObjects:
    ...
    def __init__(self, dist, R_mask_deg, z_mask_deg, los_bin_edges_as_fracs, approx_n_sky_pixels, maximum_sky_angle_rad, compute_mask = 1,
                       sky_pix_n_start_angles = 16, mask_types = ['n_vel_meas'], gal = 'fornax'):
        self.dist = dist
