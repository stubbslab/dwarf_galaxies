...
class ObservedGalaxyStarData:
    ...
    def __init__(self, population, pop_selection_method='none'):
        ...
        #self.Vhel = self.Vhel[0:50]
        #self.VhelE = self.VhelE[0:50]
        #self.corr_Vhel = self.corr_Vhel[0:50]
        #self.corr_VhelE = self.corr_VhelE[0:50]
        #self.proj_x = self.proj_x[0:50]
        #self.proj_y = self.proj_y[0:50]
